...
Pod::Spec.new do |s|
 ...
 一个可以修改网络连接地址的工具类
  ...
  # Or just: s.author    = "North"
  # s.authors            = { "North" => "yangwork@163.com" }
  # s.social_media_url   = "http://twitter.com/North"
...
s.source       = { :git => "https://github.com/openerteam/HostManagerLibrary-IPhone.git", :tag =>s.version.to_s }
  ...
  s.source_files  = "HostManager/HostManager/*.{h,m}"
  ...
  # s.resource  = "icon.png"
  s.resources = "HostManager/HostManager/resources/*.png"
